...
SEARCH_TARGETS = [
    ("iphone 12", 50000, 110000),
    ("айфон 12", 50000, 110000),
    ("айфон 13", 50000, 140000),
    ("айфон 12 про", 50000, 120000),
    ("айфон 12 про макс", 50000, 130000),
    ("айфон 13 про макс", 50000, 170000),
    ("iphone 12 pro max", 50000, 130000),
    ("iphone 13 pro max", 50000, 170000),
    ("айфон 13 про", 50000, 170000),
    ("iphone 12 pro", 50000, 120000),
    ("iphone 13", 50000, 140000),
    ("iphone 13 pro", 50000, 170000),
    ("iphone ", 50000, 110000),
    ("айфон", 50000, 110000)
]
